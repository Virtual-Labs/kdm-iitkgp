...
<title>VLS1-Admin Panel (See all experiments)</title>
...
<div id="contentTitle">
  ...
  <div id="contentText">Show Experiments</div>
  <div style="clear:both;"></div>
</div> <!-- End of contentTitle div -->
<form action="#" method="post" name="showExpList" id="showExpList">
  <div id="showCheckBox">
  <div style="float:left;">
  Action ::&nbsp;&nbsp;
  <select name="expStatusUp" id="expStatusUp">
  ...
  <div id="applyButtons"><input type="image" onclick="javascript: changeExpStatus('expStatusUp'); return false;" src="../../images/apply.jpg"  /></div>
  <div style="clear:both;"></div>
  </div>
  ...
  <div id="showAllHeaders" >
    <ul style=" padding-top:8px;">
	 <li id="titleBar" style="width:20%;">Title</li>
	 <li id="titleBar" style="width:20%;">Creator</li>
	 <li id="titleBar" style="width:31%;">Description</li>
	 <li id="titleBar" style="width:10%;">Status</li>
	 <li id="titleBar" style="width:18%;">Last Modified</li>
	 <div style="clear:both;"></div>
	</ul>
  </div>
   <?php
  ...
  <div style="float:left;">
  Action ::&nbsp;&nbsp;
  <select name="expStatusDown" id="expStatusDown" style="">
    <option value="">-- Select --</option>
    <option value="published">Publish</option>
	<option value="draft">Draft</option>
	<option value="delete">Delete</option>
  ...
  <div id="applyButtons"><input type="image" onclick="javascript: changeExpStatus('expStatusDown'); return false;"  src="../../images/apply.jpg"/></div>
  <div style="clear:both;"></div>
  </div>
  <div id="showCheckBox" style="margin-left:100px;">
  <div style="float:left;">
