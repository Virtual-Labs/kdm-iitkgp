...
<title>VLS1-Admin Panel (See all tabs)</title>
...
<div id="contentTitle">
  ...
  <div id="contentText">Show Tabs</div>
  <div style="clear:both;"></div>
</div> <!-- End of contentTitle div -->
<form action="#" method="post" name="showTabList" id="showTabList">
  <div id="showCheckBox">
  <div style="float:left;">
  Action ::&nbsp;&nbsp;
  <select name="tabStatusUp" id="tabStatusUp">
  ...
  <div id="applyButtons"><input type="image" onclick="javascript: changeTabStatus('tabStatusUp'); return false;" src="../../images/apply.jpg"  /></div>
  <div style="clear:both;"></div>
  </div>
  ...
  <div id="showAllHeaders" >
    <ul style=" padding-top:8px;">
	 ...
	 <li id="titleBar" style="width:11%;text-align:center; margin-top:-3px;"><input type="image" src="../../images/index.jpg" onclick="javascript: setTabIndex(); return false;" />     </li>
	 <div style="clear:both;"></div>
	</ul>
  </div>
   <?php
  ...
  <div style="float:left;">
  Action ::&nbsp;&nbsp;
  <select name="tabStatusDown" id="tabStatusDown" style="">
    <option value="">-- Select --</option>
    <option value="published">Publish</option>
	<option value="draft">Draft</option>
	<option value="delete">Delete</option>
  ...
  <div id="applyButtons"><input type="image" onclick="javascript: changeTabStatus('tabStatusDown'); return false;"  src="../../images/apply.jpg"/></div>
  <div style="clear:both;"></div>
  </div>
  <div id="showCheckBox" style="margin-left:100px;">
  <div style="float:left;">
