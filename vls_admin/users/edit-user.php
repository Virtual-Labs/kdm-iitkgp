          ...
          <table class="noBorderTable" align="left" border="0" width="100%">
            <tbody>
              <tr>
                ...
                <td class="text" align="left" width=""><input name="email" id="email" type="text" size="50" value="<?php echo $row['email']; ?>">
                  <span style="color:#0099CC;font-weight: bold;">*</span> </td>
              </tr>
              <tr>
                <td class="text" align="left"> Password </td>
                <td class="text" align="left"><input name="password" id="password" type="password" type="text" size="50" value="<?php echo $row['password']; ?>">
                  <span style="color: #0099CC;font-weight: bold;">*</span> </td>
              </tr>
              <!--<tr>
              ...
              <tr>
                ...
                <td class="text" align="left"><input name="f_name" id="f_name" type="text" size="50" value="<?php echo $row['f_name']; ?>">
                </td>
              </tr>
              <tr>
                <td class="text" align="left"> Last Name </td>
                <td class="text" align="left"><input name="l_name" id="l_name" type="text" size="50" value="<?php echo $row['l_name']; ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text" align="left"><input name="ph_no" id="ph_no" type="text" size="50" value="<?php echo $row['ph_no']; ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text" align="left"><input name="college" id="college" type="text" size="50" value="<?php echo $row['college']; ?>">
                </td>
              </tr>
              <tr>
                <td class="text" align="left"> Subject </td>
                <td class="text" align="left"><input name="subject" id="subject" type="text" size="50" value="<?php echo $row['subject']; ?>">
                </td>
              </tr>
              <tr>
                <td class="text" align="left"> University </td>
                <td class="text" align="left"><input name="university" id="university" type="text" size="50" value="<?php echo $row['university']; ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text" align="left"><input name="state" id="state" type="text" size="50" value="<?php echo $row['state']; ?>"></td>
              </tr>
              <tr>
