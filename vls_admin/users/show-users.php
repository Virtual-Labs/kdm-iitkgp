...
<div id="contentTitle">
  ...
  <div id="contentText">Show Users</div>
...
<form action="#" method="post" name="showUserList" id="showUserList">
  ...
  Action ::&nbsp;&nbsp;
  <select name="userStatusUp" id="userStatusUp">
  ...
  <div id="showAllHeaders" >
    <ul style=" padding-top:8px;">
	 ...
	 <li id="titleBar" style="width:10%;">User Type</li>
	 <li id="titleBar" style="width:18%;">Contact No.</li>
	 <li id="titleBar" style="width:20%;float:right;">Status</li>
	 <div style="clear:both;"></div>
	</ul>
  </div>
   <?php
