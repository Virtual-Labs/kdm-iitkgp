...
define('YOUR_APP_SECRET', '74a990aa2b19b4e28bc55eae31b6995f');
...
function get_facebook_cookie($app_id, $app_secret) { 
  ...
  /*echo "<br>";
  echo "https://graph.facebook.com/oauth/access_token?client_id=$app_id&redirect_uri=&client_secret=$app_secret&code={$signed_request['code']}";
  exit();*/
        echo $access_token_response = file_get_contents("https://graph.facebook.com/oauth/access_token?client_id=$app_id&redirect_uri=&client_secret=$app_secret&code={$signed_request['code']}");
		exit();
